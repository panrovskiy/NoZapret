...
fun getLocalizedStrategyName(name: String): String {
    return when (name) {
        ...
        "RU Discord (Alt 2)" -> stringResource(R.string.strategy_ru_discord_alt_2)
        ...
        "Modern YouTube (Extreme)" -> stringResource(R.string.strategy_modern_youtube_extreme)
        ...
        "Universal Web (Safe)" -> stringResource(R.string.strategy_universal_web_safe)
        ...
        "Strategy 6" -> stringResource(R.string.strategy_6)
        "Strategy 7" -> stringResource(R.string.strategy_7)
        "Strategy 8" -> stringResource(R.string.strategy_8)
        "Strategy 9" -> stringResource(R.string.strategy_9)
...
fun getLocalizedStrategyDesc(name: String, fallback: String): String {
    return when (name) {
        ...
        "RU Discord (Alt 2)" -> stringResource(R.string.strategy_ru_discord_alt_2_desc)
        ...
        "Modern YouTube (Extreme)" -> stringResource(R.string.strategy_modern_youtube_extreme_desc)
        ...
        "Universal Web (Safe)" -> stringResource(R.string.strategy_universal_web_safe_desc)
